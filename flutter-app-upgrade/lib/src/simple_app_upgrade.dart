...
class _SimpleAppUpgradeWidget extends State<SimpleAppUpgradeWidget> {
    ...
    return Ink(
      decoration: BoxDecoration(
          borderRadius: BorderRadius.only(
              bottomLeft: Radius.circular(widget.dialogBorderRadius))),
      child: InkWell(
          borderRadius: BorderRadius.only(
              bottomLeft: Radius.circular(widget.dialogBorderRadius)),
          child: Container(
  ...
  _buildOkActionButton() {
    ...
    if (widget.force) {
      borderRadius =
          BorderRadius.all(Radius.circular(widget.buttonBorderRadius));
    }
  ...
  _clickOk() async {
    ...
    if (Platform.isIOS) {
      ...
      if (widget.iosAppId?.isNotEmpty ?? false) {
        FlutterUpgrade.toAppStore(widget.iosAppId);
      } else if (widget.downloadUrl?.isNotEmpty ?? false) {
        FlutterUpgrade.toIosUrl(widget.downloadUrl);
      }
      return;
    }
