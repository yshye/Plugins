...
class AppUpgrade {
  ...
  static appUpgrade(
    ...
    double buttonBorderRadius = 20.0,
    double dialogBorderRadius = 20.0,
    EdgeInsets buttonMargin = EdgeInsets.zero,
    String iosAppId,
    ...
    future.then((AppUpgradeInfo appUpgradeInfo) {
      if (appUpgradeInfo != null && appUpgradeInfo.title != null) {
        _showUpgradeDialog(
            context, appUpgradeInfo.title, appUpgradeInfo.content,
    ...
    showDialog(
        ...
        builder: (context) {
          return WillPopScope(
            ...
            child: Dialog(
                insetPadding:
                    EdgeInsets.symmetric(horizontal: 45.0, vertical: 24.0),
                shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.all(Radius.circular(dialogBorderRadius))),
