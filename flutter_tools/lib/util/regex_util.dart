...
class RegexUtil {
  ...
  /// 自然数
  static final String regexAllNumber = r'^(\-|\+)?\d+(\.\d+)?$';

  /// 正数
  static final String regexPositiveNumber = r'^(\+)?\d+?$';
  ...
  static final String regexZh = r"[\u4E00-\u9FA5\uF900-\uFA2D]";

  /// 提取所有中文，包括标点符号
  static final String regexZhAll = "[^\\x00-\\xff]+";
